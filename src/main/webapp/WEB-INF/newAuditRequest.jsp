...
<body>
	...
	<div class="container-md form_box mt-5">
		<form:form action="/requests/create" method="post"
			modelAttribute="auditRequest">
			<div class="mb-3 row">
				<form:label path="request" class="form-label col-5 text-center">Request:</form:label>
			...
			<div class="d-flex justify-content-evenly">
				...
				<button type="submit" class="btn btn-primary" value="submit_form">Create
					Request</button>
			</div>
		</form:form>
	</div>
